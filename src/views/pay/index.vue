<template>
 <div class="pay">
    ...
    <div class="pay-list">
      <div class="list">
        <div class="goods-item" v-for="item in orderList.goodsList" :key="item.goods_id" @click="goDetail(item.goods_id)">
            <div class="left">
    ...
    <div class="footer-fixed">
      <div class="left">实付款：<span>￥{{orderList.orderPayPrice}}</span></div>
...
export default {
  ...
  methods: {
    ...
    async getOrderList () {
      let res
      if (this.mode === 'cart') {
        res = await checkOrder(this.mode, { cartIds: this.cartIds })
      } else {
        res = await checkOrder(this.mode, { goodsId: this.goodsId, goodsNum: this.goodsNum, goodsSkuId: this.goodsSkuId })
      }
    ...
    async submit () {
      if (this.mode === 'cart') {
        ...
        await submitOrder(this.mode, { goodsId: this.goodsId, goodsNum: this.goodsNum, goodsSkuId: this.goodsSkuId, remark: this.remark })
      }
